...
function Reports({ stats }) {
  return <>
    ...
    <section className="supervisor-report-grid"><article className="supervisor-panel chart-panel chart-wide"><div className="supervisor-panel-heading"><div><p className="supervisor-eyebrow">Growth</p><h2>Monthly User Growth</h2></div><span className="chart-trend">+18.4%</span></div><SupervisorLineChart /></article><article className="supervisor-panel chart-panel"><div className="supervisor-panel-heading"><div><p className="supervisor-eyebrow">Distribution</p><h2>Role Distribution</h2></div></div><SupervisorDonutChart values={[42, 18, 12]} labels={["Employees", "HR", "Experts"]} /></article><article className="supervisor-panel chart-panel chart-wide"><div className="supervisor-panel-heading"><div><p className="supervisor-eyebrow">Workspace activity</p><h2>Weekly Activity</h2></div><span className="supervisor-muted-label">Last 7 days</span></div><SupervisorBarChart values={[28, 44, 31, 57, 42, 68, 52]} labels={["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]} /></article></section>
